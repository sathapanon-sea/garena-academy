    ...
    <JobDetail
      ...
      :skills="[
        ...
        },
        {
          ...
          description:
            'ในส่วนนี้จริง ๆ แล้วอาจไม่ใช่ทักษะหลักที่ Sound Designer จำเป็นต้องมี และเรื่องของการประพันธ์ดนตรีสำหรับเกมไม่ได้เป็นหน้าที่หลักหรือความรับผิดชอบหลักของ Sound Designer ปกติแล้วเรื่องของการสร้างดนตรีประกอบเกมนั้นจะเป็นหน้าที่ของ Music Composer แต่ในการทำงานจริง ๆ ในบางองค์กรอาจไม่ได้มีผู้รับผิดชอบ Music Composer โดยตรง ทำให้ Sound Designer อาจต้องรับผิดชอบดูแลในส่วนนี้ด้วย ดังนั้น ถ้ามีความรู้เรื่องของดนตรี การประพันธ์ดนตรี หรือการใช้เครื่องมือสำหรับการช่วยประพันธ์ดนตรีบ้างก็จะทำให้ได้เปรียบสำหรับการทำงาน ช่วยให้การทำงานราบรื่นมากขึ้น',
          imgSrc: 'sound-designer/ใช้เครื่องมือและอุปกรณ์.png',
        },
        {
      ...
      :characterDetails="[
        ...
        'มีีความเป็นนักทดลอง รู้สึกสนุกกับการได้ทดลองสร้างเสียงแปลก ๆ ใหม่ ๆ',
        'เป็นคนที่มีจินตนาการและความคิดสร้างสรรค์',
        'เป็นคนที่มีความแน่วแน่และจดจ่ออยู่กับสิ่งใดสิ่งหนึ่งได้นาน ๆ',
        'เป็นคนที่มีความอดทนสูง และพร้อมที่จะเรียนรู้อยู่เสมอ',
        'จัดสรรเวลาเป็น สามารถแบ่งเวลาการทำงาน การใช้ชีวิต และการพักผ่อนได้อย่างสมดุล',
      ]"
